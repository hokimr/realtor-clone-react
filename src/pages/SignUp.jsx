    ...
    <section>
        ...
        <div className='flex justify-center flex-wrap
            ...
            <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6 '>
                <img src='https://images.unsplash.com/photo-1584433144859-1fc3ab64a957?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8cGFzc3dvcmR8ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60'
                alt='key'
            ...
            <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
                <form >
                    ...
                    <input 
                        ...
                        {showPassword ? <AiFillEye className='absolute right-3 top-3 text-xl cursor-pointer'
